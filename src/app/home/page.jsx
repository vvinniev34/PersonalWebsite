...
const HomePage = () => {
  ...
  const introduction = 
    <div className="flex w-auto">
      ...
      <div className="w-full whitespace-no-wrap">Hi, I'm Vincent! Dedication, hard work all the time, and belief. If you think you're perfect already, then you never will be. <br/>-Christiano Ronaldo
      </div>
    </div>
