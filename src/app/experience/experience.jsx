...
import { education, workExperience } from "./timelineInfo.js";
import "../globals.css";
...
const ExperiencePage = () => {
  ...
  return (
    <section
      ...
      id="experience"
    >
      <div className="mobileImageBackground" style={{ overflow: "hidden" }}>
        <div
          style={{
            position: "absolute",
            height: "100%",
          ...
          >
            <div className="w-[90%] flex flex-wrap">
              ...
              >
                <SubHeader
                  title={"Education"}
                  description={TimelineElement(education)}
                  color={"#f6f7f2"}
                ></SubHeader>
              </div>
              <div style={{ flex: "1 0 55%", boxSizing: "border-box" }}>
                <SubHeader
                  title={"Work"}
                  description={TimelineElement(workExperience)}
                  color={"#f6f7f2"}
                ></SubHeader>
              </div>
            </div>
